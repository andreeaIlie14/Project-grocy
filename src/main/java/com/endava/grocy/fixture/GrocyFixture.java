...
public class GrocyFixture {
    ...
    public GrocyFixture createEntity(EntityType entityType) throws IllegalAccessException {
        ...
        switch (entityType) {
            ...
            default: {
                throw new IllegalAccessException("Don't know how to create" + entityType);
            }
        }
